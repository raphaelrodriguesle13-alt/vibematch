#!/usr/bin/env bash
# Concede LOGIN + senha aos papéis de runtime criados pelas migrations.
# A senha NUNCA é concatenada dentro da string SQL. Usamos a interpolação com
# quoting do psql (:'var'), que escapa o literal corretamente.
...
for role in auth account profile matchmaking video moderation billing; do
